Below you will find a lot of detail about how membership and leagues work at Triangle Curling Club. This is the information we will need to build a registration and member management system.

Membership and fees

The existing Membership & Leagues FAQ has a lot of detail about how membership and registration works. I have added some comments after some of the answers to provide more context (these are prefixed with a > character).

I am a full-time graduate student. Am I eligible for the Student Discount (30%)?

Yes! All full-time students - grade school, college, graduate school - are eligible for the student discount. Part time students are not eligible for this discount. Triangle Curling reserves the right to request proof of enrollment.

> When a member registers, they will be able to select "student discount" to receive 30% off. Anyone who selects this discount will be required to specify the school, college, or university in which they attend as a full time student.
 

My first season began in a winter session. Do I have to pay full dues for the next fall season?

Yes, the "curling calendar year" starts in September. Everyone's fees start over for Fall. We offer a discount ($50.00 as of the 2025-26 season) to members joining for the winter season only.

> Registration takes place twice per year: once for the league session that runs September–December, and once for the session that runs January–April. A membership is required to join leagues, and is valid from September 1 through August 31 of the following year.
...
> A social membership is $50 and gets you on the official membership roster, but without any curling privileges. We will pay your GNCC, USA Curling, and USWCA membership dues on your behalf.
 

Are fees different for Junior curling?

Yes, at least for the Junior Recreational program. The Junior Recreational program has a per-session fee of $100 (Fall or Winter; total cost for both seasons is $200). The Junior Advanced Commitment program is treated as a regular league for cost purposes. Assuming the Junior is a full time student (stay in school, kids!), they would be eligible for the 30% discount. Effectively, the Advanced Commitment program counts as a regular league.  See our interactive tool to understand costs and benefits.
...
> "Basic ice privileges" gets you unlimited sparing, practice, and allows you to play in the daytime leagues.
...
> This is for our current/old system, so this process is likely to change!

Can I change or update my registration after I submit the form?

If you want to make any changes to your registration, you may fill out the registration form again. If you register multiple times, your most recent registration will replace any prior registrations. You may also request changes by emailing membership@trianglecurling.com.

> We should allow registrants to update their registration at a later time.
...
> When a returning member is registering, this should be made extremely clear during the league selection process. We should show them which leagues they were in the previous season and have a quick "check two leagues you'd like to return to".
...
Then, within a few days after priority registration has ended and the league placement process has been completed, the league coordinator for each league you are registered for will contact you through email, welcoming you to the league. Communication from league coordinators serves as confirmation of which league(s) you are registered for. If we are unable to give you the number of leagues that you requested, we will refund you the difference. Make sure emails from membership@trianglecurling.com go to your Inbox and not your Spam folder.

> We will likely continue to invoice members for their dues, but it will be automated via the QuickBooks API. Once a day we can run a job that refreshes the invoice status for each member to set a flag that they have paid. Admins should be able to override this flag (sometimes the Treasurer grants an extension for paying dues).
...
> We will want to add a property to leagues that specifies whether it is a "bring your own team" league (like Tuesday) or an individual registration league.
...
If you'd like to see the lottery results, please contact membership@trianglecurling.com after registration has concluded.
...
> Individual league managers may want to collect a survey from the members on the league roster to get info such as teammate preferences. Low priority, but eventually we can think about implementing this.
...
> We should continue to send a confirmation email after registration

Can I register after the priority registration deadline?

Yes! After priority registration has ended, league registration is first come, first served, for leagues which still have room.
...
Membership & Leagues Dues

The following is information about our membership and league dues.
Fees (2025-2026 curling season)
Note: The membership and dues structure has changed for the 2025-2026 curling season. As part of this restructuring, the Family Discount has been removed. Furthermore, all leagues throughout the year are set at the same price.

Membership Type	Rate
2025-2026 Base Membership	$200.00
Each league	$120.00
Daytime league or spare-only	$80.00
Social membership (includes association dues)	$50.00
Junior recreational membership (fall OR winter session)	$100.00
Discounts
See below for details and restrictions.

Discount Type	Details
Student discount	30% off membership & leagues
Reciprocal discount	$75.00 off membership
Winter-only discount	$50.00 off membership

> The reciprocal discount is for members who have a primary membership at another curling club. We do not pay GNCC, USA Curling, or USWCA dues on behalf of reciprocal members, and they do not get voting rights.

Someone who has registered for at least one league in both fall and winter sessions get the following benefits for their dues:
Annual benefits (September 1–August 31)
...
Fall benefits (September 1–December 31)
...
Participate in 2 leagues

Winter benefits (January–May 31)
Building access (door and security codes)
Unlimited practice when ice is available
Participate in Tuesday and Wednesday Daytime Leagues at no extra cost
Unlimited sparing
...
Additional information related to junior and minor members:

- only juniors (under 20 years old) may register for the junior recreational or junior advanced commitment programs
- minors (under 18 years old) may play in regular leagues, provided 1) they are at least 12 years old, 2) they have permission from a junior coordinator, 3) the junior completes the free online training "SafeSport for Youth Athletes", and 4) the minor's parents have taken the free online training "Parents Guide to Misconduct in Sport".
- any adult placed on the same team as a minor must complete the SafeSport® Trained program

A blurb on our website states:
Triangle Curling welcomes juniors ages 5 and up in our Junior Recreational and Junior Advanced Commitment programs. See Youth Curling for more information on those programs.

All of our leagues are considered adult leagues. However, junior members ages 12 to 17 may join these leagues after obtaining permission from one of our juniors coordinators. While all Triangle Curling members are expected to follow the Code of Conduct, parents should be aware that accommodations for juniors cannot be guaranteed in leagues, including members' use of language or alcoholic beverages. Junior members that have demonstrated knowledge of the game, its rules, etiquette, and basic proficiency of gameplay may contact a juniors coordinator at juniors@trianglecurling.com to receive permission for league play.

===

Saturday Instructional Program / U3 League
