...
export const memberPaymentHistoryItemSchema = {
  ...
  properties: {
    ...
    status: {
      type: 'string',
      enum: ['created', 'pending', 'succeeded', 'failed', 'pending_refund', 'refunded', 'partially_refunded'],
    },
...
export const orgRostersResponseSchema = {
  ...
  properties: {
    ...
    lastConfirmationEmailsQueuedAt: { type: ['string', 'null'] },
    lastConfirmationEmailsQueuedCount: { type: ['number', 'null'] },
    lastConfirmationEmailsSkippedNoEmail: { type: ['number', 'null'] },
    lastConfirmationEmailsConfirmByDate: { type: ['string', 'null'] },
  ...
  required: [
    ...
    'lastConfirmationEmailsQueuedAt',
    'lastConfirmationEmailsQueuedCount',
    'lastConfirmationEmailsSkippedNoEmail',
    'lastConfirmationEmailsConfirmByDate',
    'members',
    'usaCurlingTsv',
    'uswcaTsv',
  ],
  ...
  properties: {
    credentials: {
      ...
      items: {
        ...
        required: ['id', 'name', 'description', 'expiresAt', 'systemKey'],
      },
    },
  },
...
export const sparesCcResponseSchema = {
  ...
  items: {
    ...
    properties: {
      ...
      requesterParentEmail: { type: ['string', 'null'] },
...
export const spareInvitationsResponseSchema = {
  ...
  items: {
    ...
    required: ['memberId', 'name', 'email', 'parentEmail', 'status', 'declinedAt', 'declineComment', 'invitedAt'],
  },
} as const;
...
export const spareMyRequestsResponseSchema = {
  ...
  items: {
    ...
    properties: {
      ...
      filledByParentEmail: { type: ['string', 'null'] },
  ...
  properties: {
    ...
    members: {
      ...
      items: {
        type: 'object',
        additionalProperties: false,
        required: ['memberId', 'memberName', 'memberEmail', 'parentEmail', 'previousLeagues', 'registrationId', 'registrationStatus'],
        properties: {
          memberId: { type: 'number' },
          memberName: { type: 'string' },
          memberEmail: { type: ['string', 'null'] },
