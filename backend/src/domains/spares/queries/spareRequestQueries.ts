...
export async function listCcSpareRequestsForMember(memberId: number) {
  ...
  const rowsRaw = await db
    .select({
      ...
      requester_guardian_email: schema.members.guardian_email,
      requester_date_of_birth: schema.members.date_of_birth,
  ...
  return rowsRaw.map((row) => ({
    ...
    requesterParentEmail: memberContactEmails({
      email: row.requester_email,
      guardian_email: row.requester_guardian_email,
      date_of_birth: row.requester_date_of_birth,
    }).parentEmail,
...
export async function listUpcomingOwnSpareRequests(memberId: number) {
  ...
  const requests = await db
    .select({
      ...
      filled_by_guardian_email: schema.members.guardian_email,
      filled_by_date_of_birth: schema.members.date_of_birth,
  ...
  return requests.map((row) => {
    ...
    return {
      ...
      filledByParentEmail: memberContactEmails({
        email: row.filled_by_email,
        guardian_email: row.filled_by_guardian_email,
        date_of_birth: row.filled_by_date_of_birth,
      }).parentEmail,
