...
export const membersSqlite = sqliteTable('members', {
  ...
  // Lifetime members do not pay annual membership or registration league fees.
  lifetime_member: integer('lifetime_member').default(0).notNull(),
...
export const leaguesSqlite = sqliteTable('leagues', {
  ...
  team_formation: text('team_formation').notNull().default('coordinator').$type<'coordinator' | 'skips_draft'>(),
  created_at: text('created_at').default(sql`datetime('now')`).notNull(),
  updated_at: text('updated_at').default(sql`datetime('now')`).notNull(),
}, (table) => ({
...
export const siteConfigSqlite = sqliteTable('site_config', {
  ...
  wordmark_url: text('wordmark_url'),
  contact_email: text('contact_email'),
  contact_phone: text('contact_phone'),
  physical_address_line1: text('physical_address_line1'),
  physical_address_line2: text('physical_address_line2'),
  mailing_address_line1: text('mailing_address_line1'),
  mailing_address_line2: text('mailing_address_line2'),
  footer_markdown: text('footer_markdown'),
  hero_badge: text('hero_badge'),
  hero_title: text('hero_title'),
  hero_subtitle: text('hero_subtitle'),
  announcement_markdown: text('announcement_markdown'),
...
export const menuItemsSqlite = sqliteTable('menu_items', {
  ...
  label: text('label').notNull(),
  sort_order: integer('sort_order').default(0).notNull(),
  link_type: text('link_type').$type<'internal' | 'external' | 'separator'>(),
  url: text('url'),
...
export const membersPg = pgTable('members', {
  ...
  lifetime_member: integerPg('lifetime_member').default(0).notNull(),
...
export const leaguesPg = pgTable('leagues', {
  ...
  team_formation: textPg('team_formation').notNull().default('coordinator').$type<'coordinator' | 'skips_draft'>(),
  created_at: timestamp('created_at', { withTimezone: false }).defaultNow().notNull(),
  updated_at: timestamp('updated_at', { withTimezone: false }).defaultNow().notNull(),
}, (table) => ({
...
export const siteConfigPg = pgTable('site_config', {
  ...
  wordmark_url: textPg('wordmark_url'),
  contact_email: textPg('contact_email'),
  contact_phone: textPg('contact_phone'),
  physical_address_line1: textPg('physical_address_line1'),
  physical_address_line2: textPg('physical_address_line2'),
  mailing_address_line1: textPg('mailing_address_line1'),
  mailing_address_line2: textPg('mailing_address_line2'),
  footer_markdown: textPg('footer_markdown'),
  hero_badge: textPg('hero_badge'),
  hero_title: textPg('hero_title'),
  hero_subtitle: textPg('hero_subtitle'),
  announcement_markdown: textPg('announcement_markdown'),
  announcement_expires_at: timestamp('announcement_expires_at', { withTimezone: false }),
  updated_at: timestamp('updated_at', { withTimezone: false }).defaultNow().notNull(),
});
...
export const menuItemsPg = pgTable('menu_items', {
  ...
  label: textPg('label').notNull(),
  sort_order: integerPg('sort_order').default(0).notNull(),
  link_type: textPg('link_type').$type<'internal' | 'external' | 'separator'>(),
  url: textPg('url'),
