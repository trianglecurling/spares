...
const leagueBootstrapColumnsSQLite: { name: string; ddl: string }[] = [
  ...
  { name: 'is_junior_recreational', ddl: 'is_junior_recreational INTEGER NOT NULL DEFAULT 0' },
...
const leagueBootstrapColumnsPg: string[] = [
  ...
  'ALTER TABLE leagues ADD COLUMN IF NOT EXISTS is_junior_recreational INTEGER NOT NULL DEFAULT 0',
