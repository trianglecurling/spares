              ...
              <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-8">
                ...
                <div className="prose max-w-none space-y-6 text-gray-700 dark:text-gray-300">
                  <section>
                    ...
                    <p className="mb-3">
                      All your spare requests are available on the "My requests" page, organized by status:
                    </p>
                    <ul className="list-disc list-inside space-y-2">
                      <li><strong>Open requests:</strong> Still looking for a spare</li>
                      <li><strong>Filled requests:</strong> Someone has signed up</li>
                      <li><strong>Canceled requests:</strong> You've canceled the request</li>
                    </ul>
                    <p className="mt-4">
                  ...
                  <section>
                    ...
                    <p className="mt-4 text-sm text-gray-600 dark:text-gray-400">
                      <strong>Note:</strong> You can only cancel open requests. If someone has already signed up, 
                      you'll need to contact them directly if plans change.
                    </p>
                  </section>
                  ...
                  <section>
                    ...
                    <ol className="list-decimal list-inside space-y-3">
                      <li>
                        <strong>After 72 hours:</strong> If it's been more than 72 hours since notifications were last sent, 
                        you can re-issue to send fresh notifications
                      </li>
                      <li>
                        <strong>After a cancellation:</strong> If someone signed up and then canceled their spare offer, 
                        you can immediately re-issue the request
                      </li>
                    </ol>
                  ...
                  <section>
                    ...
                    <p className="mb-3">
                      For public requests with staggered notifications:
                    </p>
                    <ul className="list-disc list-inside space-y-2">
                      <li><strong>Pause:</strong> Temporarily stop sending notifications</li>
                      <li><strong>Unpause:</strong> Resume sending notifications</li>
                      <li>Useful if you need to temporarily halt notifications for any reason</li>
                      <li>The request remains visible on dashboards, but no new notifications are sent</li>
                  ...
                  <section>
                    ...
                    <p className="mb-3">
                      On each open request card, you can see:
                    </p>
                    <ul className="list-disc list-inside space-y-2">
                      ...
                      <li><strong>"All notifications sent. X members notified":</strong> All notifications have been completed</li>
                      <li><strong>"(Paused)":</strong> Notifications are currently paused</li>
                      <li><strong>Status updates automatically</strong> as notifications are sent</li>
                    </ul>
                  </section>
                  ...
                  <section>
                    ...
                    <p className="mb-3">
                      When someone signs up to fill your spare request:
                    </p>
                    <ul className="list-disc list-inside space-y-2">
                  ...
                  <section>
                    ...
                    <p className="mb-3">
                      If someone who signed up cancels their spare offer:
                    </p>
                    <ul className="list-disc list-inside space-y-2">
                  ...
                  <section>
                    ...
                    <p className="mb-3">
                      Your dashboard shows a summary of your requests:
                    </p>
                    <ul className="list-disc list-inside space-y-2">
                      <li><strong>"My spare requests":</strong> Shows your open and filled requests (not canceled)</li>
                      <li><strong>"My upcoming sparing":</strong> Shows requests you've signed up to fill</li>
                      <li>Both sections only show future games (past games are filtered out)</li>
                      <li>Click through to "My requests" for full details and management options</li>
                    </ul>
                  </section>
                </div>
